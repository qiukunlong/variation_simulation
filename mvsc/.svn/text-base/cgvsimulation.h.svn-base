...
const double blood_snp_variation_ratio=static_cast <double >(1000)/1101;
const double blood_indel_variation_ratio=static_cast <double >(100)/1101;
const double blood_sv_variation_ratio=static_cast <double >(1)/1101;

const double para_snp_variation_ratio=static_cast <double >(50)/61;//60
...
const double cancer_snp_variation_ratio=static_cast <double >(50)/61;//600
...
const int kInversionLenU = 2000000;
...
struct MVSCOption
{
	...
	*/
	...
	{//Initialization
		chr.assign("chr17");
		//	hg_ref.assign("/ifs2/Cancer/lidan/0_data_ref/hg19/hg19.fa");
		//	virus_ref.assign("/ifs2/Cancer/lidan/0_data_ref/hpv_gene/all_hpv_genome_corr.seq");
		//hg_ref.assign("/ifshk1/BC_CANCER/00database/human_19/hg19.fa");
        //virus_ref.assign("/ifshk1/BC_CANCER/03user/lidan/database/all_hpv_genome_corr.seq");

		blood_variation_ratio=0.001;
	...
	void Compute()
	{
		blood_ref.assign(output_dir).append("/blood.fa");
		blood_snp_info.assign(output_dir).append("/blood.snp.info");
		blood_indel_info.assign(output_dir).append("/blood.indel.info");
		blood_sv_info.assign(output_dir).append("/blood.sv.info");
		blood_inseq_info.assign(output_dir).append("/blood.insertseq.fa");
		blood_cnv_info.assign(output_dir).append("/blood.cnv.info");
...
struct variation_ratio
{
	...
	{
		b_indel_variation_ratio=mvsc.blood_variation_ratio*blood_indel_variation_ratio;
		b_snp_variation_ratio=mvsc.blood_variation_ratio*blood_snp_variation_ratio;
		b_ins_variation_ratio=mvsc.blood_variation_ratio*blood_sv_variation_ratio*0.3;
		b_del_variation_ratio=mvsc.blood_variation_ratio*blood_sv_variation_ratio*0.45;
		b_inv_variation_ratio=mvsc.blood_variation_ratio*blood_sv_variation_ratio*0.25;
		p_indel_variation_ratio=mvsc.para_variation_ratio*para_indel_variation_ratio;
		p_snp_variation_ratio=mvsc.para_variation_ratio*para_snp_variation_ratio;
		p_ins_variation_ratio=mvsc.para_variation_ratio*para_sv_variation_ratio*0.3;
		p_del_variation_ratio=mvsc.para_variation_ratio*para_sv_variation_ratio*0.45;
		p_inv_variation_ratio=mvsc.para_variation_ratio*para_sv_variation_ratio*0.25;
		c_indel_variation_ratio=mvsc.cancer_variation_ratio*cancer_indel_variation_ratio;
		c_snp_variation_ratio=mvsc.cancer_variation_ratio*cancer_snp_variation_ratio;
		c_ins_variation_ratio=mvsc.cancer_variation_ratio*cancer_sv_variation_ratio*0.3;
		c_del_variation_ratio=mvsc.cancer_variation_ratio*cancer_sv_variation_ratio*0.45;
		c_inv_variation_ratio=mvsc.cancer_variation_ratio*cancer_sv_variation_ratio*0.25;
